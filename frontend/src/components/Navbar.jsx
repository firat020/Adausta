      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {menuAcik && (
          <div className="md:hidden py-3 border-t border-gray-100 flex flex-col gap-1">
            ...
            <Link to="/usta-kayit" onClick={() => setMenuAcik(false)} className="mt-1 bg-blue-600 text-white text-sm font-semibold px-3 py-2.5 rounded-lg text-center">Usta Kaydı</Link>
          </div>
        )}
      </div>
    </nav>
