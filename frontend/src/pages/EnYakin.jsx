    ...
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      {!konumAlindi ? (
        <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-12 text-center mb-8">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">{t('enYakin.konumPaylas')}</h2>
          ...
          <button onClick={konumAl} disabled={yukleniyor}
            ...
            <Navigation size={16} />
            {yukleniyor ? t('enYakin.konumAliniyor') : t('enYakin.konumKullan')}
          </button>
          {hata && (
        ...
        <>
          ...
          <div className="flex items-center gap-3 bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3 mb-5">
            ...
            <div>
              <p className="text-sm font-semibold text-emerald-800">{t('enYakin.konumAlindi')}</p>
      ...
      {yukleniyor ? (
        ...
        <div className="text-center py-16 text-gray-400">
          ...
          <p className="font-medium text-gray-500">{t('enYakin.bulunamadi')}</p>
          <p className="text-sm mt-1">{t('enYakin.farkliKategori')}</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
