    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <form onSubmit={formGonder} className="bg-white border border-indigo-100 shadow-sm rounded-2xl overflow-hidden">
        ...
        <div className="p-6 border-b border-indigo-50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <input type="email" required value={form.email}
                onChange={e => setForm(f => ({ ...f, email: e.target.value }))}
                className={inputCls} placeholder="info@sirketiniz.com" />
              <p className="text-xs text-gray-400 mt-1">Şirket paneline bu e-posta ve aşağıdaki şifre ile giriş yapacaksınız.</p>
            </div>
            <div>
          ...
          <p className="text-xs text-gray-400 mt-2">Bu e-posta ve şifre ile şirket panelinize giriş yapacaksınız.</p>
        </div>
